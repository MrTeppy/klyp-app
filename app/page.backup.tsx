      ...
      <div className="mx-auto max-w-md px-4 pb-32 pt-5">
        ...
        <header className="mb-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button className="relative active:scale-90 transition-transform">
              ...
              <span className="absolute -top-1 -right-1 h-2.5 w-2.5 rounded-full bg-[#C9A27E] border-2 border-[#fdf4e7]" />
            </button>
            <div
              onClick={() => router.push("/profile")}
              className="h-9 w-9 rounded-full bg-gradient-to-br from-[#C9A27E] to-[#C9A27E] cursor-pointer active:scale-90 transition-transform"
            />
          </div>
        </header>
        ...
        <div className="mb-5 flex gap-3 overflow-x-auto pb-1 scrollbar-hide">
          ...
          {stories.map((story) => (
            <div key={story.label} className="flex flex-shrink-0 flex-col items-center gap-1.5">
              ...
              >
                {/* Golden ring */}
                <div className="absolute inset-0 rounded-full p-[2px]" style={{ background: "linear-gradient(135deg, #C9A27E, #C9A27E)" }}>
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <div className="h-9 w-9 rounded-full bg-gradient-to-br from-[#C9A27E] to-[#C9A27E]" />
          ...
          {posts.map((post) => (
            ...
            >
              ...
              <div className="mb-3 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-gradient-to-br from-[#C9A27E] to-[#C9A27E]" />
                  <div>
      ...
      >
        <div className="mx-auto flex max-w-md items-center justify-around px-6 py-3">
          <button className="flex flex-col items-center gap-1 active:scale-90 transition-transform">
            <span className="text-[10px] font-medium text-[#C9A27E]">Home</span>
          </button>
          ...
          <button
            ...
            style={{ background: "linear-gradient(135deg, #C9A27E, #C9A27E)" }}
          >
            +
          </button>
